...
class MainWindow(QMainWindow):
    ...
    # Subscriber function
    def subscriber(self):
            rospy.Subscriber('/drive_system/odometry_new',Odometry,self.odomback)
    ...
    def encoder_angle(self,data):
        self.ui.angle_1.setNum(round((data.data[0]-2048)/2048*90))
        self.ui.angle_2.setNum(round((data.data[1]-2048)/2048*90))
        self.ui.angle_3.setNum(round((data.data[2]-2048)/2048*90))
        self.ui.angle_4.setNum(round((data.data[3]-2048)/2048*90))
